            ...
            <div className='py-16'>
                ...
                <div>
                    {templateUtils.salon.expectations.map((exp, ind) => (
                        <div
                            key={ind}
                            className='text-white grid grid-cols-[1fr_10fr] gap-2 max-w-[1400px] m-2 md:mx-auto md:my-2 py-2 px-2 border rounded hover:translate-x-1 hover:font-semibold cursor-default'
                        >
                            <div className='flex justify-end items-center'>
                                <i className='pi pi-check-square'></i>
                            </div>
                            <div>
                                <p>{`${exp.title}: ${exp.content}.`}</p>
                            </div>
                        </div>
                    ))}
                </div>
