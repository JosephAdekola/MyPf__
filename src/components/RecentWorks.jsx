          ...
          >
            <div className="work-image-wrapper">
              <div className="work-image-container">
                <img src={wor.image} alt={wor.name} className="work-image" />
              </div>
            </div>
            <div className={`work-hover-info ${!isHovered ? 'hover-out' : ''}`}>
              <div className="hover-text">
                <h3 className="hover-title">{wor.name}</h3>
                <p>{wor.description}</p>
              </div>
              <div className="hover-icon">
                <a href={wor.anchor} target="_blank" rel="noreferrer">
                  <i
                    className={`${wor.arrow} hover-arrow`}
                    style={{ transform: `rotate(${isHovered ? '0' : '-180'}deg)` }}
                  ></i>
                </a>
              </div>
            </div>
